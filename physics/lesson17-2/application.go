...
func (app *Application) Setup() {
	...
	bigBall := physics.NewBody(physics.NewCircleShape(100), 100, 100, 1.0)
	smallBall := physics.NewBody(physics.NewCircleShape(50), 500, 100, 1.0)
...
func (app *Application) Input() {
	...
	for event := sdl.PollEvent(); event != nil; event = sdl.PollEvent() {
		...
		case *sdl.MouseMotionEvent:
			...
			app.bodies[0].Position.X = float64(t.X)
			app.bodies[0].Position.Y = float64(t.Y)
		}
	}
}
