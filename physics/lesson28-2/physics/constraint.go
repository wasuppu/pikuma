...
func NewJointConstraint(a, b *Body, anchorPoint Vec2) *JointConstraint {
	return &JointConstraint{ConstraintBase{a: a, b: b, aPoint: a.WorldSpaceToLocalSpace(anchorPoint), bPoint: b.WorldSpaceToLocalSpace(anchorPoint)}, NewMat(1, 6), make(Vec, 1)}
}

func (c *JointConstraint) PreSolve() {
