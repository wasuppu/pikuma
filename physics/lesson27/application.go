...
func (app *Application) Setup() error {
	...
	// Add two bodies
	a := physics.NewBody(physics.NewCircleShape(30), float64(app.graphic.windowWidth)/2, float64(app.graphic.windowHeight)/2, 0.0)
	b := physics.NewBody(physics.NewCircleShape(20), a.Position.X-100, a.Position.Y, 1.0)
	app.world.AddBody(a)
	app.world.AddBody(b)
