...
func (app *Application) Setup() error {
	...
	bigBall := physics.NewBody(physics.NewCircleShape(64), float64(app.graphic.windowWidth)/2, float64(app.graphic.windowHeight)/2, 0.0)
	bigBall.SetTexture(filepath.Join(parentpath, "assets/bowlingball.png"), app.graphic.renderer)
	app.world.AddBody(bigBall)
