...
func (app *Application) Update() {
	...
	app.particle.Acceleration = physics.Vec2{X: 2.0 * PIXELS_PER_METER, Y: 9.8 * PIXELS_PER_METER}

	// Integrate the acceleration and velocity to estimate the new position
	app.particle.Velocity = app.particle.Velocity.Add(app.particle.Acceleration.Muln(deltaTime))
	app.particle.Position = app.particle.Position.Add(app.particle.Velocity.Muln(deltaTime))
