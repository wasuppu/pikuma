...
func render() {
	...
	for i := range trianglesToRender {
		...
		// Draw vertex points
		drawRect(int32(triangle.points[0].x), int32(triangle.points[0].y), 3, 3, 0xFFFFFF00) // vertex A
		drawRect(int32(triangle.points[1].x), int32(triangle.points[1].y), 3, 3, 0xFFFFFF00) // vertex B
		drawRect(int32(triangle.points[2].x), int32(triangle.points[2].y), 3, 3, 0xFFFFFF00) // vertex C
